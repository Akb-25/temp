...
# log_file = open("pruningBaseTrained.csv", mode="w", newline='')
# log_file_2 = open("pruningBaseTrainedBest.csv", mode="w", newline='')
...
def prune(rec, dec, classifier, train_loader, optimizer, criterion):
    ...
    while True:
        ...
        torch.save(rec, f"modelsBaseTrained/{pruning_iteration}_rec.pth")
        torch.save(dec, f"modelsBaseTrained/{pruning_iteration}_dec.pth")
        torch.save(classifier, f"modelsBaseTrained/{pruning_iteration}_classifier.pth")
